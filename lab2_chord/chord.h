...
private:
	/*
	* Calculate i_th interval start (n + 2^(i-1) % 2^m
	*
	...
	* 
	* @param in socket of incoming connection
	*/
	...
	*/
	...
	/*
	* Update current finger table if s is i_th finger of this when new node is joining (execute at the remote node, 
